...
from pandas.tools import plottting
...
#exposong them as pandas.Dataframe
...
#Student's t-test: the simple statistical test##
...
# FSQIP and PIQ are measured on the same individuals and the variance due to inter-subject variability is confounding, and can be removed, using a "paired test", or "repeated measures test"
...
# this is done in seaborn using robust=True in the plotting functions or in statsmodels by replacing the use of the OLS by a "Robust Linear Model"
